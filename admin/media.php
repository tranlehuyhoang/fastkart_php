                    ...
                    <div class="card-body">
                        <div class="title-header option-title justify-content-start">
                            ...
                            <div class="selected-options">
                                <ul>
                                    ...
                                    <li><a class="dropdown-item d-flex align-items-center" href="#" id="downloadSelected" data-bs-original-title="" title=""><i class="ri-download-2-line me-2"></i>Download</a></li>
                                    <li><a href="#" id="deleteSelected" data-bs-original-title="" title=""><i class="ri-delete-bin-line"></i></a></li>
                                </ul>
                            </div>
                            <div class="right-options ms-auto">
                                <ul>
                                    <li>
                                        <a class="btn btn-solid" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#mediaModel" data-bs-original-title="" title="">Add
                                            Media</a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            ?>
                                <div>
                                    <div class="library-box">
                                        <input type="checkbox" name="images[]" id="myCheckbox<?php echo $index ?>" class="imageCheckbox" data-bs-original-title="" title="">
                                        <label for="myCheckbox<?php echo $index ?>">
                                            <div class="b_size_content bg-size" style="background-image: url(&quot;<?php echo $imageUrl ?>&quot;); background-size: cover; background-position: center center; background-repeat: no-repeat; display: block;">
                                                <img src="<?php echo $imageUrl ?>" class="img-fluid bg-img bg_size_content" alt="" style="display: none;">
                                            </div>
                                            <div class="dropdown">
                                                <a class="" href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false" data-bs-original-title="" title="">
                                                    <i class="ri-more-fill"></i>
                                                </a>
                                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuLink">
                                                    <li><a class="dropdown-item d-flex align-items-center" href="<?php echo $imageUrl ?>" download="" data-bs-original-title="" title=""><i class="ri-download-2-line me-2"></i>Download</a></li>
                                                    <li><a class="dropdown-item d-flex align-items-center deleteImage" href="http://localhost:1000/admin/media/1/delete" data-bs-original-title="" title=""><i class="ri-delete-bin-line me-2"></i>Delete</a></li>
                                                </ul>
                                            </div>
                                        </label>
                                    </div>
                        ...
                        <script>
                            ...
                            document.getElementById('deleteSelected').addEventListener('click', function() {
                                ...
                                fetch('http://localhost:1000/admin/medias', {
                                        method: 'POST',
                                        headers: {
