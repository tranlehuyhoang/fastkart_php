            ...
            <div class="sidebar-wrapper">
                ...
                <div>
                    <div class="logo-wrapper logo-wrapper-center">
                        <a href="http://localhost:1000/admin" data-bs-original-title="" title="">
                            <img class="img-fluid for-white"
                                src="http://localhost:1000/assets_admin/images/logo/full-white.png" alt="logo">
                        </a>
                        <div class="back-btn">
                    ...
                    <div class="logo-icon-wrapper">
                        <a href="http://localhost:1000/admin">
                            <img class="img-fluid main-logo main-white"
                                src="http://localhost:1000/assets_admin/images/logo/logo.png" alt="logo">
                            <img class="img-fluid main-logo main-dark"
                                src="http://localhost:1000/assets_admin/images/logo/logo-white.png" alt="logo">
                        </a>
                    </div>
                        ...
                        <div id="sidebar-menu">
                            <ul class="sidebar-links" id="simple-bar">
                                ...
                                <li class="sidebar-list">
                                    <a class="sidebar-link sidebar-title link-nav" href="http://localhost:1000/admin">
