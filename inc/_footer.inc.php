            ...
            <div class="row g-md-4 gy-sm-5 gy-2">
                <div class="col-xxl-3 col-xl-4 col-sm-6">
                    <a href="index.html" class="foot-logo">
                        <img src="../public/assets_client/images/logo/3.png" class="img-fluid" alt="">
                    </a>
        ...
        <div class="sub-footer section-small-space">
            ...
            <div class="right-footer">
                <ul class="payment-box">
                    <li>
                        <img src="../public/assets_client/images/icon/paymant/visa.png" alt="">
                    </li>
                    <li>
                        <img src="../public/assets_client/images/icon/paymant/discover.png" alt="">
                    </li>
                    <li>
                        <img src="../public/assets_client/images/icon/paymant/american.png" alt="">
                    </li>
                    <li>
                        <img src="../public/assets_client/images/icon/paymant/master-card.png" alt="">
                    </li>
                    <li>
                        <img src="../public/assets_client/images/icon/paymant/giro-pay.png" alt="">
                    </li>
                </ul>
            </div>
        </div>
...
<div class="item-section">
    ...
    <ul class="items-image">
        <li>
            <img src="../public/assets_client/images/veg-3/cate1/1.png" alt="">
        </li>
        <li>
            <img src="../public/assets_client/images/veg-3/cate1/2.png" alt="">
        </li>
        <li>+3</li>
    </ul>
...
<!-- Auto Height Js -->
<script src="../public/assets_client/js/auto-height.js"></script>

<!-- Quantity Js -->
<script src="../public/assets_client/js/quantity.js"></script>

<!-- Timer Js -->
<script src="../public/assets_client/js/timer1.js"></script>
<script src="../public/assets_client/js/timer2.js"></script>
<script src="../public/assets_client/js/timer3.js"></script>
<script src="../public/assets_client/js/timer4.js"></script>

<!-- Fly Cart Js -->
<script src="../public/assets_client/js/fly-cart.js"></script>

<!-- WOW js -->
<script src="../public/assets_client/js/wow.min.js"></script>
<script src="../public/assets_client/js/custom-wow.js"></script>
