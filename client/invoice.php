            ...
            <tr>
                <td>
                    ...
                    <table style="padding: 27px;" align="center" border="0" cellpadding="0" cellspacing="0"
                        ...
                        <tr>
                            <td>
                                <img src="../public/assets_client/order-success-poster.png" alt=""
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    <a href="../public/product/6">
                                                        <img src="../public/<?php echo $result['image'] ?>" alt=""
                                                            style="height: 80px"></a>
                                                </td>
                                                <td
                                                    style="padding: 28px 0;border-bottom: 1px solid rgba(217, 217, 217, 0.5);">
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" class="order-table"
                        style="background-image: url(../public/assets_client/order-poster.jpg);">
                        <tbody>
                            <tr>
                                <td>
