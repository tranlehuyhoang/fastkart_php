                                        ...
                                        <div class="row g-2">
                                                ...
                                                <div class="product-main-2 no-arrow">
                                                    <div>
                                                        <div class="slider-image">
                                                            <img height="100%" width="100%" src="../public/<?php echo $result['image'] ?>" id="img-1" data-zoom-image="../public/<?php echo $result['image'] ?>" class="img-fluid image_zoom_cls-0 blur-up lazyload" alt="">
                                                        </div>
                                                    </div>

                                                    <div>
                                                        <div class="slider-image">
                                                            <img src="../public/assets_client/images/product/category/2.jpg" data-zoom-image="../public/assets_client/images/product/category/2.jpg" class="img-fluid image_zoom_cls-1 blur-up lazyload" alt="">
                                                        </div>
                                                    </div>

                                                    <div>
                                                        <div class="slider-image">
                                                            <img src="../public/assets_client/images/product/category/3.jpg" data-zoom-image="../public/assets_client/images/product/category/3.jpg" class="img-fluid image_zoom_cls-2 blur-up lazyload" alt="">
                                                        </div>
                                                    </div>

                                                    <div>
                                                        <div class="slider-image">
                                                            <img src="../public/assets_client/images/product/category/4.jpg" data-zoom-image="../public/assets_client/images/product/category/4.jpg" class="img-fluid image_zoom_cls-3 blur-up lazyload" alt="">
                                                        </div>
                                                    </div>

                                                    <div>
                                                        <div class="slider-image">
                                                            <img src="../public/assets_client/images/product/category/5.jpg" data-zoom-image="../public/assets_client/images/product/category/5.jpg" class="img-fluid image_zoom_cls-4 blur-up lazyload" alt="">
                                                        </div>
                                                    </div>

                                                    <div>
                                                        <div class="slider-image">
                                                            <img src="../public/assets_client/images/product/category/6.jpg" data-zoom-image="../public/assets_client/images/product/category/6.jpg" class="img-fluid image_zoom_cls-5 blur-up lazyload" alt="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xxl-2 col-lg-12 col-md-2 order-xxl-1 order-lg-2 order-md-1">
                                                <div class="left-slider-image-2 left-slider no-arrow slick-top">
                                                    ...
                                                    <div>
                                                        <div class="sidebar-image">
                                                            <img src="../public/assets_client/images/product/category/2.jpg" class="img-fluid blur-up lazyload" alt="">
                                                        </div>
                                                    </div>

                                                    <div>
                                                        <div class="sidebar-image">
                                                            <img src="../public/assets_client/images/product/category/3.jpg" class="img-fluid blur-up lazyload" alt="">
                                                        </div>
                                                    </div>

                                                    <div>
                                                        <div class="sidebar-image">
                                                            <img src="../public/assets_client/images/product/category/4.jpg" class="img-fluid blur-up lazyload" alt="">
                                                        </div>
                                                    </div>

                                                    <div>
                                                        <div class="sidebar-image">
                                                            <img src="../public/assets_client/images/product/category/5.jpg" class="img-fluid blur-up lazyload" alt="">
                                                        </div>
                                                    </div>

                                                    <div>
                                                        <div class="sidebar-image">
                                                            <img src="../public/assets_client/images/product/category/6.jpg" class="img-fluid blur-up lazyload" alt="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="note-box product-packege">
                                                <div class="cart_qty qty-box product-qty">
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control input-number qty-input" type="number" name="quantity" value="1">
                                                        <input class=" " type="number" style="display: none;" name="product" value="<?php echo $result['id'] ?>">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="javascript:void(0)">
                                                        <img src="../public/assets_client/images/product/payment/1.svg" class="blur-up lazyload" alt="">
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)">
                                                        <img src="../public/assets_client/images/product/payment/2.svg" class="blur-up lazyload" alt="">
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)">
                                                        <img src="../public/assets_client/images/product/payment/3.svg" class="blur-up lazyload" alt="">
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)">
                                                        <img src="../public/assets_client/images/product/payment/4.svg" class="blur-up lazyload" alt="">
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)">
                                                        <img src="../public/assets_client/images/product/payment/5.svg" class="blur-up lazyload" alt="">
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                <div class="col-12">
                                    <div class="product-section-box">
                                        <ul class="nav nav-tabs custom-nav" id="myTab" role="tablist">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link" id="info-tab" data-bs-toggle="tab" data-bs-target="#info" type="button" role="tab" aria-controls="info" aria-selected="false">Additional
                                                    info</button>
                                            </li>

                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link" id="care-tab" data-bs-toggle="tab" data-bs-target="#care" type="button" role="tab" aria-controls="care" aria-selected="false">Care
                                                    Instuctions</button>
                                            </li>
                                            ...
                                            <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                                                <div class="product-description">
                                                    ...
                                                    <div class="banner-contain nav-desh">
                                                        <img src="../public/assets_client/images/vegetable/banner/14.jpg" class="bg-img blur-up lazyload" alt="">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <div class="review-people">
                                                                <ul class="review-list">
                                                                    <?php
                                                                    $reviews = $reviewclass->getReviewByProduct($_GET['product']);
                                                                                    ...
                                                                                    <div class="people-box">
                                                                                        <div>
                                                                                            <div class="people-image">
                                                                                                <img src="../public/assets_client/images/review/1.jpg" class="img-fluid blur-up lazyload" alt="">
                                                                                            </div>
                                                                                        </div>

                                                                                        <div class="people-comment">
                                                                                            <a class="name" href="javascript:void(0)"><?php echo $result['name'] ?></a>
                                                                                            <div class="date-time">
                                                                                            ...
                                                                                            <div class="reply">
                                                                                                <p><?php echo $result['description'] ?><a href="javascript:void(0)">Reply</a>
                                                                                                </p>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                    ...
                                                                    <li>
                                                                        <div class="people-box">
                                                                            <div>
                                                                                <div class="people-image">
                                                                                    <img src="../public/assets_client/images/review/2.jpg" class="img-fluid blur-up lazyload" alt="">
                                                                                </div>
                                                                            </div>
                                                                    ...
                                                                    <li>
                                                                        <div class="people-box">
                                                                            <div>
                                                                                <div class="people-image">
                                                                                    <img src="../public/assets_client/images/review/3.jpg" class="img-fluid blur-up lazyload" alt="">
                                                                                </div>
                                                                            </div>
                            ...
                            <div class="right-sidebar-box">
                                <div class="vendor-box">
                                    <div class="verndor-contain">
                                        <div class="vendor-image">
                                            <img src="../public/assets_client/images/product/vendor.png" class="blur-up lazyload" alt="">
                                        </div>
                                    ...
                                    <div class="category-menu">
                                        ...
                                        <ul class="product-list product-right-sidebar border-0 p-0">
                                            <li>
                                                <div class="offer-product">
                                                    <a href="product-left-thumbnail.html" class="offer-image">
                                                        <img src="../public/assets_client/images/vegetable/product/23.png" class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                            ...
                                            <li>
                                                <div class="offer-product">
                                                    <a href="product-left-thumbnail.html" class="offer-image">
                                                        <img src="../public/assets_client/images/vegetable/product/24.png" class="blur-up lazyload" alt="">
                                                    </a>
                                            ...
                                            <li>
                                                <div class="offer-product">
                                                    <a href="product-left-thumbnail.html" class="offer-image">
                                                        <img src="../public/assets_client/images/vegetable/product/25.png" class="blur-up lazyload" alt="">
                                                    </a>
                                            ...
                                            <li class="mb-0">
                                                <div class="offer-product">
                                                    <a href="product-left-thumbnail.html" class="offer-image">
                                                        <img src="../public/assets_client/images/vegetable/product/26.png" class="blur-up lazyload" alt="">
                                                    </a>
                                ...
                                <div class="ratio_156 pt-25">
                                    <div class="home-contain">
                                        <img src="../public/assets_client/images/vegetable/banner/8.jpg" class="bg-img blur-up lazyload" alt="">
                            ...
                            <div class="product-header">
                                <div class="product-image">
                                    <a href="product-left.htm">
                                        <img src="../public/assets_client/images/cake/product/11.png" class="img-fluid blur-up lazyload" alt="">
                                    </a>
                    ...
                    <div>
                        <div class="product-box-3 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="product-header">
                                <div class="product-image">
                                    <a href="product-left-thumbnail.html">
                                        <img src="../public/assets_client/images/cake/product/7.png" class="img-fluid" alt="">
                                    </a>
