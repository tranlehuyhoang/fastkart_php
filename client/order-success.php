                            ...
                            <tbody>
                                ...
                                <tr>
                                        ...
                                        <div class="product border-0">
                                            ...
                                            <div class="product-detail">
                                                <ul>
                                                    ...
                                                    <li class="text-content">Quantity: 2</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="price">
                                        ...
                                        <h6 class="theme-color">$4.00</h6>
                                    </td>

                                    <td class="quantity">
                                        <h4 class="table-title text-content">Qty</h4>
                                        <h4 class="text-title">2</h4>
                                    </td>
                    ...
                    <div class="col-lg-12 col-sm-6">
                        <div class="summery-box">
                            <div class="summery-header">
                                <h3>Price Details</h3>
                                <h5 class="ms-auto theme-color">(2 Items)</h5>
                            </div>
                            ...
                            <form class="summery-total" action="http://localhost:1000/checkout/re_payment"
                                method="post">
                                <input type="hidden" name="_token" value="dtInwvHPFf6jkJk2Tq8Px096VlnviXtFM0VqTtBf"
                                    autocomplete="off"> <input type="number" style="display: none"
                                    value="7447981838527103" name="vnp_TxnRef">
                                <input type="number" style="display: none" value="8" name="totalPrice">
                                <button type="submit"
                                    class="btn theme-bg-color text-white btn-md w-100 mt-4 fw-bold">Thanh
                                    toán</button>
                            </form>
                        </div>
                    </div>
